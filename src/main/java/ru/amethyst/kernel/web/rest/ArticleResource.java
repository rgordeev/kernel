...
import ru.amethyst.kernel.service.ArticleService;
...
/**
 * REST controller for managing {@link ru.amethyst.kernel.domain.Article}.
 */
@RestController
@RequestMapping("/api")
public class ArticleResource {
    ...
    public ResponseEntity<ArticleDTO> partialUpdateArticle(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, articleDTO.getId().toString())
        );
    }
