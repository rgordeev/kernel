...
/**
 * REST controller for managing {@link ru.amethyst.kernel.domain.Block}.
 */
@RestController
@RequestMapping("/api")
public class BlockResource {
    ...
    public ResponseEntity<BlockDTO> partialUpdateBlock(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, blockDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/blocks")
    public ResponseEntity<List<BlockDTO>> getAllBlocks(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
