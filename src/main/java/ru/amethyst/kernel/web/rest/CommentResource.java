...
import ru.amethyst.kernel.repository.CommentRepository;
import ru.amethyst.kernel.service.CommentService;
...
/**
 * REST controller for managing {@link ru.amethyst.kernel.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
