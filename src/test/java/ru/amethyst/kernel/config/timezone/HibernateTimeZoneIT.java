package ru.amethyst.kernel.config.timezone;
...
import ru.amethyst.kernel.repository.timezone.DateTimeWrapper;
import ru.amethyst.kernel.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM suz_date_time_wrapper where id=%d", fieldName, id);
    }
